...
class DonateSponsorshipPage extends StatefulWidget {
  const DonateSponsorshipPage({super.key,required this.sponsorshipDetailsmodel});
...
class _DonateSponsorshipPageState extends State<DonateSponsorshipPage> {
  ...
  void onTextChanged(String value) {
    ...
    setState(() {
      selectedAmount = (entered != null && entered > 0 && entered <= widget.sponsorshipDetailsmodel.remainingAmount!) ? entered : null;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Sponsorship Donation".tr(),style: AppTextStyle.a,),
        ...
        child: BackgroundWrapper(
          child: Column(
            ...
            children: [
                    ...
                    child: Row(
                      children: [Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("\$ ${widget.sponsorshipDetailsmodel.remainingAmount}" , style: AppTextStyle.a,),
                            Text("Remaining amount".tr(),style: AppTextStyle.helpReq,)
                          ],
                        ),
                      ),
                      SizedBox(width: 60,),
              ...
              Padding(
                ...
                child: Text("This amount will be charged monthly automatically".tr(),style: AppTextStyle.d,),
              ),
          ...
          child: Row(
            ...
            children: amounts.map((amount) {
              ...
              final isDisabled = amount> widget.sponsorshipDetailsmodel.remainingAmount!;
              return Expanded(
                child: Padding(
            ...
            child: TextFormField(
              ...
              validator: (value) {
               final val = int.tryParse(value ?? '') ?? 0;
                if (val > widget.sponsorshipDetailsmodel.remainingAmount!) return "Amount exceeds remaining sponsorship amount";
          ...
          child: ElevatedButton(
            onPressed: isValid && selectedAmount! <= widget.sponsorshipDetailsmodel.remainingAmount! && formKey.currentState!.validate()
                ? () {

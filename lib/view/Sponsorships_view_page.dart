...
class _SponsorshipsViewPageState extends State<SponsorshipsViewPage> {
  ...
  context.read<AllSponsorshipsBlocBloc>()..add(FetchAllSponsorships());
   ...
   context.read<SponsorshipsByCategoryBlocBloc>()..add(FetchSponsorshipsByCategory(widget.categoryId));
                                 ...
                                 : DecorationImage(image: AssetImage("assets/images/general.png"),fit: BoxFit.cover)
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(textmax( state.allSponsorships[index].title ??"unknown", 22)
                                           ,
                                 ...
                                 : DecorationImage(image: AssetImage("assets/images/general.png"),fit: BoxFit.cover)
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(textmax(state.SponsorshipsByCategory[index].title ??"unknown", 22),

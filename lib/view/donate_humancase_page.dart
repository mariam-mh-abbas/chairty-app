...
class _DonateHumancasePageState extends State<DonateHumancasePage> {
  ...
  void onTextChanged(String value) {
    ...
    setState(() {
      selectedAmount = (entered != null && entered > 0 && entered <= widget.detailshumanncasesmodel.remainingAmount!) ? entered : null;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("HumanCase Donation".tr(),style: AppTextStyle.a,),
                    ...
                    child: Row(
                      children: [Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("\$ ${widget.detailshumanncasesmodel.remainingAmount.toString()}" , style: AppTextStyle.a,),
  ...
  final isDisabled = amount > widget.detailshumanncasesmodel.remainingAmount!;
          ...
          child: Form(
            ...
            child: TextFormField(
              ...
              validator: (value) {
                ...
                if (val > widget.detailshumanncasesmodel.remainingAmount!) return "Amount exceeds remaining campaign amount";
...
Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>CharityFundPage()));
            ...
            child:  Row(
              ...
              children: [
                ...
                SizedBox(width: 10),
                Text("Add to Cart".tr(), style: TextStyle(fontSize: 16)),
              ],
            ),
          ),
        ),

        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const Text(
                  "You just brought happiness to someone's heart.\nMay Allah reward you greatly.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const Text(
                  "Your gift has been received and will bring comfort to someone in need.\nYour kindness makes a real difference.\nMay you be abundantly rewarded.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Color.fromARGB(148, 0, 0, 0),
                    fontWeight: FontWeight.w600,
          ...
          child: Column(
            children: [
              ...
              const Text("Thank you for your willingness to donate!",
                      textAlign: TextAlign.center, style: AppTextStyle.a)
                  .tr(),
              const Text("Please sign in first to proceed.",
                      textAlign: TextAlign.center, style: AppTextStyle.d)
                  .tr(),
              SizedBox(
                height: 30,
              ),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text(msg, textAlign: TextAlign.center, style: AppTextStyle.a)
                  .tr(),
              const Text("Please sign in first to proceed.",
                      textAlign: TextAlign.center, style: AppTextStyle.d)
                  .tr(),

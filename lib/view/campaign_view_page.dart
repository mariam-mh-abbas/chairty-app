...
class _CampaignViewPageState extends State<CampaignViewPage> {
 Future<void> refreshData( BuildContext context)async{
  context.read<AllCampaignBloc>()..add(FetchAllCampaign());
   ...
   context.read<CampaignByCategoryIdBloc>()..add(FetchCampaignByCategoryId(widget.categoryId));
...
BlocProvider<CampaignByCategoryIdBloc>(
    ...
    : null;
                                  final collected = state.Allcampaigns[index].collectedAmount ?? 0;
                              final goal = state.Allcampaigns[index].goalAmount ?? 0;
                                  return Padding(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(textmax(state.Allcampaigns[index].title ?? "unknown", 22) ,style: AppTextStyle.b,),
                                  ...
                                  Padding(
                                    ...
                                    child: ElevatedButton(onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>OneCampaignPage(id: state.Allcampaigns[index].id ?? 0,
    ...
    ? Uri.parse(baseUrlImage).resolve(imageUrl).toString()
    : null;
                                  final collected = state.CampaignByCategory[index].collectedAmount ?? 0;
                              final goal = state.CampaignByCategory[index].goalAmount ?? 0 ;
                                  return Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 10,vertical: 5),
                    child: Container(
                      height: 190,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(textmax(state.CampaignByCategory[index].title ?? "unknown", 22),style: AppTextStyle.b,),
                                  SizedBox(height: 50,width: 200,
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(left: 90,top: 5),
                                    child: ElevatedButton(onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>OneCampaignPage(id: state.CampaignByCategory[index].id ?? 0,

...
class _HumanitariancasesViewPageState extends State<HumanitariancasesViewPage> {
  Future<void> refreshData(BuildContext context) async {
    ...
    context.read<HumancaseByCategoryBloc>()
      ..add(FetchHumancaseByCategoryEvent(widget.categoryId));
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => HumancaseByCategoryBloc()
            ..add(FetchHumancaseByCategoryEvent(widget.categoryId)),
        ),
      ],
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: BackgroundWrapper(
              child: widget.categoryId == 0
                          ...
                          if (state.humanCasemodel.isEmpty) {
                            return Center(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "There is no HumanitarianCases yet",
                  ...
                  : BlocBuilder<HumancaseByCategoryBloc,
                      HumancaseByCategoryState>(
                      builder: (context, state) {
                          ...
                          if (state.humancasebycategory.isEmpty) {
                            return Center(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "There is no HumanitarianCases yet".tr(),
                                    style: AppTextStyle.b,
                                  ),
                                  Image.asset(
                                    "assets/images/option 1.png",

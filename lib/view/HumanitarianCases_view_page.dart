                      ...
                      itemBuilder: (context, index) {
                         final String imageUrl=state.humanCasemodel[index].image!;
                          final String finalImage =Uri.parse("$baseUrlImage").resolve(imageUrl).toString();
                               final collected = state.humanCasemodel[index].collectedAmount!;
                          final goal =state.humanCasemodel[index].goalAmount!;
                        return Padding(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(textmax(state.humanCasemodel[index].title!, 25)
                                          ,
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>OneHumanitariancasesViewPage(id: state.humanCasemodel[index].id!,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(textmax(state.humancasebycategory[index].title!, 25)
                                          ,
                                          style: AppTextStyle.b,
                                        ),
                                        SizedBox(
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>OneHumanitariancasesViewPage(id: state.humancasebycategory[index].id!,

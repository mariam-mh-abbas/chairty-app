...
class _OneCampaignPageState extends State<OneCampaignPage> {
  ...
  context.read<BlocDetailsCampaignBloc>()..add(FetchDetailsCampaignEvent(widget.id));
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(state.campaignsDetails.endDate !=null
                                    ? DateFormat('d/M/yyyy', 'en').format(state.campaignsDetails.endDate!)
                                    : "",
                                    style: AppTextStyle.helpReq,
                                  )
                                ],

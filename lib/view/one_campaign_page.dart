...
class _OneCampaignPageState extends State<OneCampaignPage> {
  Future<void> refreshData(BuildContext context) async {
    context.read<BlocDetailsCampaignBloc>()
      ..add(FetchDetailsCampaignEvent(widget.id));
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          BlocDetailsCampaignBloc()..add(FetchDetailsCampaignEvent(widget.id)),
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: BackgroundWrapper(
            ...
            height: 800,
            child:
                BlocBuilder<BlocDetailsCampaignBloc, BlocDetailsCampaignState>(
                ...
                if (state is BlocDetailsCampaignLoading) {
                  ...
                  final String? finalImage =
                      imageUrl != null && imageUrl.isNotEmpty
                          ...
                          : null;
                  final collected = state.campaignsDetails.collectedAmount ?? 0;
                  final goal = state.campaignsDetails.goalAmount ?? 0;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            state.campaignsDetails.title ?? "unknown",
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "\$ ${state.campaignsDetails.remainingAmount}" +
                                      "Remaining".tr(),
                                  style: AppTextStyle.d,
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      "${state.campaignsDetails.beneficiariesCount.toString()}" +
                                          "person".tr(),
                                      style: AppTextStyle.helpReq,
                                    )
                                  ],
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      state.campaignsDetails.startDate != null
                                          ? DateFormat('d/M/yyyy', 'en').format(
                                              state.campaignsDetails.startDate!)
                                          : "",
                                      style: AppTextStyle.helpReq,
                                    )
                                  ],
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      state.campaignsDetails.endDate != null
                                          ? DateFormat('d/M/yyyy', 'en').format(
                                              state.campaignsDetails.endDate!)
                                          : "",
                                      style: AppTextStyle.helpReq,
                                    )
                                  ],

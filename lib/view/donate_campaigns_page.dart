  ...
  void onTextChanged(String value) {
    ...
    setState(() {
      selectedAmount = (entered != null &&
              entered > 0 &&
              entered <= widget.detailsCampaignModel.remainingAmount!)
          ? entered
          : null;
    });
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "\$ ${widget.detailsCampaignModel.remainingAmount.toString()}",
                                style: AppTextStyle.a,
                              ),
                              Text(
                                "Remaining amount",
                    ...
                    child: Row(
                      ...
                      children: amounts.map((amount) {
                        ...
                        final isDisabled = amount >
                            widget.detailsCampaignModel.remainingAmount!;
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: isValid &&
                              selectedAmount! <=
                                  widget
                                      .detailsCampaignModel.remainingAmount! &&
                              formKey.currentState!.validate()
                          ? () {
                              final item = CartItemModel(
                                  id: int.parse(
                                      "${widget.detailsCampaignModel.id}2"),
                      ...
                      onPressed: isValid &&
                          ...
                          ? () async {
                              ...
                              final item = CartItemModel(
                                  ...
                                  boxId: null,
                                  image:
                                      "$baseUrl/storage/${widget.detailsCampaignModel.image}",
                                  Amount: selectedAmount,
                                  donationType: "Campaign",
                                  periodic: "Once");

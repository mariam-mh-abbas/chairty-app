...
class _VolunteerRequestPageState extends State<VolunteerRequestPage> {
  ...
  void submitForm() async {
    ...
    final model = VolunteerRequestModel(
      ...
      previousVolunteer: hasPreviousExperience ? experiencedetails.text : null,
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            left: 20, right: 20, bottom: 20, top: 20),
                        child: Text(
                          'Preferred Volunteering Type:'.tr(),
                          style: AppTextStyle.helpReq,
                        ),
                      ),
                      Row(
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Availability and Preferred Time:'.tr(),
                          style: AppTextStyle.helpReq,
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            left: 20, right: 20, bottom: 4, top: 18),
                        child: Text(
                          'Previous Volunteering Experience: '.tr(),
                          style: AppTextStyle.helpReq,
                        ),
                      ),
                      Column(
                                      ...
                                      child: Row(
                                        children: [
                                          Radio(
                                              activeColor: AppColors.primary,
                                              value: true,
                                              groupValue: hasPreviousExperience,
                                              onChanged: (val) => setState(() {
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: AppInputDecoration.defaultDecoration
                                    .copyWith(
                                  labelText:
                                      "Please mention your experience or organizations:"
                                          .tr(),
                                ),
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 20, right: 20, bottom: 20, top: 20),
                            child: Text(
                              'Additional Notes or Details:'.tr(),
                              style: AppTextStyle.helpReq,
                            ),
                          ),
                          Padding(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                                "I agree to the terms and conditions of\nvolunteering at the association."
                                    .tr(),
                                style:
                                    AppTextStyle.helpReq.copyWith(fontSize: 13))
                          ],
                        ),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: 230, right: 30, top: 20, bottom: 20),

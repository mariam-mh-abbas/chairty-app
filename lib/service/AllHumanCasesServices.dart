...
class Allhumancasesservices extends Baseservice{
  Future<List<dynamic>?> getAllHumanCases() async{
try {
final savedLang = await SharedPrefs.getLanguage() ?? 'en';
  responce=await dio.get("$baseURL/${ApiResourses.allhumancases}",options: Options(
    headers: {

...
class ArchivedHumanCasesModel {
  ...
  factory ArchivedHumanCasesModel.fromJson(String str) =>
      ArchivedHumanCasesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ArchivedHumanCasesModel.fromMap(Map<String, dynamic> json) =>
      ArchivedHumanCasesModel(
        id: json["id"] as int?,

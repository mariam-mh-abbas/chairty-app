...
//       AddToCart event, Emitter<BlocCartState> emit) async {
//     final index =
//         cartItems.indexWhere((element) => element.id == event.cartItem.id);
//     if (index != -1) {
//       final updatedItem = cartItems[index].copyWith(
//         Amount: (cartItems[index].Amount ?? 0) + (event.cartItem.Amount ?? 0),
//       );
...
//       DeleteFromCart event, Emitter<BlocCartState> emit) async {
...
//       ClearCart event, Emitter<BlocCartState> emit) async {
//     cartItems.clear();
//     emit(ClearedCart());
//   }
...
//       if (jsonList != null) {
//         cartItems.addAll(
//             jsonList.map((itemJson) => CartItemModel.fromJson(itemJson)));
//       }
...
//       LoggedOut event, Emitter<BlocCartState> emit) async {
//     cartItems.clear();
//     emit(ClearedCart());
//   }
// }
